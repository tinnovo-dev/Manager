...
/**
 * The default database username. This will set the default 'username'
 * property for all FileMaker objects created via the API
 */
// $__FM_CONFIG['username'] = '';

/**
 * The default database password. This will set the default 'password'
 * property for all FileMaker objects created via the API
 */
// $__FM_CONFIG['password'] = '';

/**
 * The default database name. This will set the default 'database'
 * property for all FileMaker objects created via the API
 */
// $__FM_CONFIG['database'] = '';
