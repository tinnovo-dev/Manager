...
class EasyGoogleMap {
	 ...
	 */
	function GmapsKey() {
		//return "<js head=\"1\" type=\"text/javascript\" src=\"http://maps.google.com/maps?file=api&v=2&key={$this->mMapKey}\" />" ;///*** EasyGoogleMap Class by: Mitchelle Pascual ***/</script>\n";
		return "<js head=\"1\" type=\"text/javascript\" src=\"http://maps.google.com/maps?file=api&v=2&key={$this->mMapKey}\"></js>\n";
		//return '<js head="1" type="text/javascript" src="http://maps.google.com/maps?file=api&v=2&key={$this->mMapKey}" />';	
	} # end function
	 ...
	 * @return: string
	 */
	function UnloadMap() {// <![CDATA[
		return "<script type=\"text/javascript\">//<!--" . "window.onunload = function() { GUnload(); }\n //--></script>";
	} # end function
